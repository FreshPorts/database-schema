--
-- $Id: createdb.sql,v 1.39 2003-01-09 19:45:28 dan Exp $
--
...
create unique index tasks_idx on task (name);
...
(
  ...
  drop sequence security_notice_id_seq;
create sequence security_notice_id_seq;

alter table security_notice alter column id set default nextval('security_notice_id_seq'::text);
